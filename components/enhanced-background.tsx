...
export default function EnhancedBackground() {
  ...
  useEffect(() => {
    ...
    class Line {
      ...
      updateColor() {
        const colorMap: { [key: string]: string } = {
          purple: theme === "dark" ? "rgba(168, 85, 247, 0.15)" : "rgba(139, 92, 246, 0.1)",
          blue: theme === "dark" ? "rgba(96, 165, 250, 0.15)" : "rgba(59, 130, 246, 0.1)",
          emerald: theme === "dark" ? "rgba(52, 211, 153, 0.15)" : "rgba(16, 185, 129, 0.1)",
          rose: theme === "dark" ? "rgba(251, 113, 133, 0.15)" : "rgba(244, 63, 94, 0.1)",
          orange: theme === "dark" ? "rgba(251, 146, 60, 0.15)" : "rgba(249, 115, 22, 0.1)",
          cyan: theme === "dark" ? "rgba(34, 211, 238, 0.15)" : "rgba(6, 182, 212, 0.1)",
          indigo: theme === "dark" ? "rgba(129, 140, 248, 0.15)" : "rgba(99, 102, 241, 0.1)",
          pink: theme === "dark" ? "rgba(244, 114, 182, 0.15)" : "rgba(236, 72, 153, 0.1)",
        }
        this.color = colorMap[currentColor.name] || colorMap.purple
      }
